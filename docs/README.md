...
8. [`THREAT_MODEL.md`](./THREAT_MODEL.md) — Phase 0 threat-model draft for the current Rust spine.
9. [`adr/`](./adr/) — architecture decision records, both from the original planning doc and any made during implementation.
